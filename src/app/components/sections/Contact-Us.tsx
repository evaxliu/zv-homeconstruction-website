...
const businessInfo = [
  ...
  { title: "HOURS", info: "Everyday, 8am - 7pm" }
]
...
export default function ContactUs() {
  ...
  const onSubmit = async (event: SubmitEvent<HTMLFormElement>) => {
    ...
    formData.append(
      "access_key",
      "be8911b4-0e62-4a1f-8738-6d6448717299"
    );
  ...
  return(
    <section className="w-full text-[#202A36]" id="contact">
      <div className="mx-auto max-w-7xl px-6 py-10 flex flex-col lg:flex-row justify-between min-h-[calc(100svh-150px)]">
